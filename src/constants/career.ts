  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        content:
          '팀 자원을 효율적으로 사용하고 개발 속도를 높이기 위해 개발 프로세스를 체계화했습니다. React, TypeScript, Next.js로 기술 스택을 통일하고 렌더링 방식별로 템플릿을 만들었습니다. 빌드 툴을 Webpack에서 Vite로 변경하고, 컴포넌트 라이브러리를 Emotion으로 구현했으며, AWS의 S3와 CloudFront를 사용하는 정적 배포 과정도 자동화했습니다. 지속적으로 프로세스를 업데이트하면서 팀의 개발 효율과 속도를 높였습니다.',
